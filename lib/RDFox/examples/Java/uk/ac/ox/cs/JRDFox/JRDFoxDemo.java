	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			try {
				...
				store.importFiles(new File[] { new File(JRDFoxDemo.class.getResource("data/additional-rules.txt").toURI()) } );
				...
				store.importFiles(new File[] { new File(JRDFoxDemo.class.getResource("data/lubm1-new.ttl").toURI()) }, DataStore.UpdateType.ScheduleForAddition);
